...
//	}
	...
	public SignInView() {
		...
		errorLabel.setBounds(10, 329, 266, 14);
		...
		bt_confirm.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	            ...
	            boolean valid = true;
	            if (username.isEmpty()) {
	            	JOptionPane.showMessageDialog(SignInView.this, "Please enter your Email address");
	                valid = false;
	            }
	            if (password.isEmpty()) {
	            	JOptionPane.showMessageDialog(SignInView.this, "Please enter your password.");
	                valid = false;
	            ...
	            if (phone.isEmpty()) {
	            	JOptionPane.showMessageDialog(SignInView.this, "Please enter your phone number.");
	                valid = false;
	            }
